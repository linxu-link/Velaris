 ...
 * 导航状态的状态持有者。
 *
 * @param startKey - 起始导航键。用户将通过此键退出应用。
 * @param topLevelStack - 一级导航返回栈。仅包含一级导航键。
 * @param subStacks - 每个一级导航键对应的子返回栈。
 */
class NavigationState(
    ...
    val currentSubStack: NavBackStack<NavKey>
        get() = subStacks[currentTopLevelKey]
            ?: error("子栈 $currentTopLevelKey 不存在")
